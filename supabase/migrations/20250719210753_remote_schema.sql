...
-- CREATE EXTENSION IF NOT EXISTS "postgis_tiger_geocoder" WITH SCHEMA "tiger"; -- Commented out, not needed for our use case
...
-- CREATE EXTENSION IF NOT EXISTS "postgis_topology" WITH SCHEMA "topology"; -- Commented out, not needed
...
CREATE OR REPLACE FUNCTION "public"."archive_unused_table"("table_name" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $_$
BEGIN
...
ALTER FUNCTION "public"."archive_unused_table"("table_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."calculate_asymmetric_escalation"("p_conflict_id" "uuid", "p_new_events" "jsonb"[] DEFAULT NULL::"jsonb"[]) RETURNS numeric
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."calculate_asymmetric_escalation"("p_conflict_id" "uuid", "p_new_events" "jsonb"[]) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."calculate_asymmetric_escalation"("p_conflict_id" "uuid", "p_new_events" "jsonb"[]) IS 'Calculates escalation score with asymmetric decay: fast to rise (25% weight for increases) but slow to fall (10% weight for decreases). Includes time-based decay after 12 hours.';



CREATE OR REPLACE FUNCTION "public"."calculate_conflict_escalation"("p_country" "text", "p_region" "text") RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_score NUMERIC := 0;
...
ALTER FUNCTION "public"."calculate_conflict_escalation"("p_country" "text", "p_region" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_event_version"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  changes JSONB;
...
ALTER FUNCTION "public"."create_event_version"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."expire_inactive_conflicts"() RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
  DECLARE
  ...
  BEGIN
      ...
      WHERE
          ...
          AND (
              last_news_update < NOW() - INTERVAL '48 hours'
              OR last_news_update IS NULL
          )
          AND updated_at < NOW() - INTERVAL '48 hours';

      GET DIAGNOSTICS expired_count = ROW_COUNT;

      -- Log the expiration if sync log table exists
      IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'conflict_sync_log') THEN
...
ALTER FUNCTION "public"."expire_inactive_conflicts"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."generate_invite_code"("p_length" integer DEFAULT 8, "p_created_by" "uuid" DEFAULT NULL::"uuid", "p_max_uses" integer DEFAULT 1, "p_expires_in_days" integer DEFAULT NULL::integer, "p_metadata" "jsonb" DEFAULT '{}'::"jsonb") RETURNS character varying
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_code VARCHAR(8);
...
ALTER FUNCTION "public"."generate_invite_code"("p_length" integer, "p_created_by" "uuid", "p_max_uses" integer, "p_expires_in_days" integer, "p_metadata" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_event_history"("p_event_id" "uuid") RETURNS TABLE("version" integer, "changes" "jsonb", "changed_by" character varying, "change_reason" character varying, "created_at" timestamp with time zone)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_event_history"("p_event_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_personalized_events"("p_user_id" "uuid", "p_limit" integer DEFAULT 100) RETURNS TABLE("id" "uuid", "title" "text", "summary" "text", "country" "text", "region" "text", "escalation_score" numeric, "event_type" "text", "tags" "text"[], "relevance_score" numeric)
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_personalized_events"("p_user_id" "uuid", "p_limit" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."log_event_deletion"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
  BEGIN
...
ALTER FUNCTION "public"."log_event_deletion"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."merge_duplicate_news"("p_existing_id" "text", "p_new_article" "jsonb") RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_outlet TEXT;
...
ALTER FUNCTION "public"."merge_duplicate_news"("p_existing_id" "text", "p_new_article" "jsonb") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."merge_duplicate_news"("p_existing_id" "text", "p_new_article" "jsonb") IS 'Merges a new article from a different outlet into an existing news item';
...
CREATE OR REPLACE FUNCTION "public"."process_all_pending_escalations"() RETURNS TABLE("conflicts_updated" integer, "conflicts_processed" integer)
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_updated INTEGER := 0;
...
ALTER FUNCTION "public"."process_all_pending_escalations"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."scheduled_escalation_update"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    -- Log the update
...
ALTER FUNCTION "public"."scheduled_escalation_update"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."sync_conflict_timestamp"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.timestamp := NEW.event_date;
  RETURN NEW;
END;
$$;


ALTER FUNCTION "public"."sync_conflict_timestamp"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."sync_news_date"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.date := NEW.published_at;
  RETURN NEW;
END;
$$;


ALTER FUNCTION "public"."sync_news_date"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."track_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_invite_code_id" "uuid" DEFAULT NULL::"uuid", "p_ip_address" "inet" DEFAULT NULL::"inet", "p_user_agent" "text" DEFAULT NULL::"text", "p_device_fingerprint" "text" DEFAULT NULL::"text", "p_session_duration_hours" integer DEFAULT 24) RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  v_session_id uuid;
...
ALTER FUNCTION "public"."track_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_invite_code_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text", "p_device_fingerprint" "text", "p_session_duration_hours" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_mark_conflict_for_update"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."trigger_mark_conflict_for_update"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_all_conflict_escalations"() RETURNS TABLE("conflict_id" "uuid", "conflict_name" "text", "old_score" integer, "new_score" numeric, "score_change" numeric)
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_conflict RECORD;
...
ALTER FUNCTION "public"."update_all_conflict_escalations"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_conflicts_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
  BEGIN
      NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_conflicts_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_country_conflict_escalations"("p_country" "text", "p_new_events" "jsonb"[]) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_conflict RECORD;
...
ALTER FUNCTION "public"."update_country_conflict_escalations"("p_country" "text", "p_new_events" "jsonb"[]) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_single_conflict_escalation"("p_conflict_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_conflict RECORD;
...
ALTER FUNCTION "public"."update_single_conflict_escalation"("p_conflict_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_timestamp_date"() RETURNS "trigger"
...
ALTER FUNCTION "public"."update_timestamp_date"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_and_redeem_invite_code"("p_code" character varying, "p_user_id" "uuid", "p_ip_address" "inet" DEFAULT NULL::"inet", "p_user_agent" "text" DEFAULT NULL::"text") RETURNS TABLE("is_valid" boolean, "error_message" "text", "invite_code_id" "uuid")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."validate_and_redeem_invite_code"("p_code" character varying, "p_user_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "archive"."analytics_events" (
...
ALTER TABLE "archive"."analytics_events" OWNER TO "postgres";


CREATE OR REPLACE VIEW "archive"."analytics_daily_summary" AS
 SELECT "date"("analytics_events"."timestamp") AS "date",
   ...
   FROM "archive"."analytics_events"
  GROUP BY ("date"("analytics_events"."timestamp")), "analytics_events"."category", "analytics_events"."action";


ALTER TABLE "archive"."analytics_daily_summary" OWNER TO "postgres";


CREATE OR REPLACE VIEW "archive"."analytics_popular_events" AS
 SELECT "analytics_events"."category",
    "analytics_events"."action",
    "analytics_events"."label",
    "count"(*) AS "event_count",
    "count"(DISTINCT "analytics_events"."session_id") AS "unique_sessions"
   FROM "archive"."analytics_events"
  WHERE ("analytics_events"."timestamp" >= ("now"() - '7 days'::interval))
  GROUP BY "analytics_events"."category", "analytics_events"."action", "analytics_events"."label"
  ORDER BY ("count"(*)) DESC;


ALTER TABLE "archive"."analytics_popular_events" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."conflicts" (
    ...
    "headline_hash" character varying(50),
    "sync_source" character varying(20) DEFAULT 'manual'::character varying,
    "auto_generated" boolean DEFAULT false,
    "last_news_update" timestamp with time zone,
    "conflict_hash" character varying(20),
    "confidence_score" numeric(3,2) DEFAULT 0.0,
    "previous_escalation_score" numeric(3,1) DEFAULT NULL::numeric,
    "escalation_event_ids" "text"[] DEFAULT '{}'::"text"[],
    "escalation_last_calculated" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "check_confidence_score_range" CHECK ((("confidence_score" >= 0.0) AND ("confidence_score" <= 1.0))),
    CONSTRAINT "check_escalation_score_range" CHECK ((("escalation_score" >= 0) AND ("escalation_score" <= 10))),
    CONSTRAINT "conflicts_conflict_type_check" CHECK (("conflict_type" = ANY (ARRAY['border'::"text", 'civil_war'::"text", 'occupation'::"text", 'insurgency'::"text", 'territorial_dispute'::"text", 'other'::"text"]))),
    CONSTRAINT "conflicts_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'ceasefire'::"text", 'resolved'::"text"])))
);
...
CREATE OR REPLACE VIEW "public"."active_conflicts" AS
 SELECT "conflicts"."id",
    "conflicts"."name",
    "conflicts"."country",
    "conflicts"."region",
    ...
    "conflicts"."escalation_score",
    "conflicts"."start_date",
    "conflicts"."updated_at",
    "conflicts"."source_article_id",
    "conflicts"."confidence_score",
    "conflicts"."last_news_update",
    "conflicts"."sync_source",
    "conflicts"."auto_generated",
    "conflicts"."conflict_hash"
   FROM "public"."conflicts"
  WHERE ("conflicts"."status" = 'active'::"text")
  ORDER BY "conflicts"."escalation_score" DESC, "conflicts"."updated_at" DESC;


ALTER TABLE "public"."active_conflicts" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."events" (
    ...
    "reliability" integer,
    "event_classifier" "text"[] DEFAULT '{}'::"text"[],
    ...
    "escalation_score" smallint DEFAULT '1'::smallint,
    ...
    "deletion_notes" "text",
    "bias_analysis_id" "uuid",
    "fact_check_id" "uuid",
    "bias_score" numeric,
    "verification_status" "text",
    "has_analysis" boolean DEFAULT false,
    CONSTRAINT "events_reliability_check" CHECK ((("reliability" >= 0) AND ("reliability" <= 10))),
...
COMMENT ON COLUMN "public"."events"."escalation_score" IS 'Event severity/escalation level (1-10): 1-3=low risk, 4-6=medium risk, 7-8=high risk, 9-10=critical';



COMMENT ON COLUMN "public"."events"."content_hash" IS 'SHA256 hash for deduplication based on title, country, city/region, and date';



COMMENT ON COLUMN "public"."events"."city" IS 'City name extracted from event location data';



COMMENT ON COLUMN "public"."events"."timestamp_date" IS 'Date part of the timestamp for deduplication indexing';



COMMENT ON COLUMN "public"."events"."event_type" IS 'Type of conflict: armed_conflict, terrorism, military_operation, civil_unrest, etc.';



COMMENT ON COLUMN "public"."events"."source" IS 'Source website/organization (e.g., reuters.com, bbc.com)';



COMMENT ON COLUMN "public"."events"."source_type" IS 'How data was obtained: intelligent_search, rss_ingestion, historical_dataset, etc.';



COMMENT ON COLUMN "public"."events"."participants" IS 'Array of actors/parties involved in the conflict';



COMMENT ON COLUMN "public"."events"."tags" IS 'Additional metadata tags for filtering and categorization';
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    ...
    "preferences" "jsonb" DEFAULT '{"theme": "dark", "language": "en", "mapStyle": "satellite", "timezone": "UTC", "newsAlerts": true, "soundAlerts": false, "autoPlayVideos": false, "refreshInterval": "5", "showEventLabels": true, "escalationAlerts": true, "pushNotifications": false, "emailNotifications": true}'::"jsonb",
    "invite_code_id" "uuid",
    CONSTRAINT "users_role_check" CHECK (("role" = ANY (ARRAY['user'::"text", 'admin'::"text", 'premium'::"text"])))
);
...
CREATE OR REPLACE VIEW "public"."archived_events" AS
 SELECT "e"."id",
    "e"."title",
    "e"."summary",
    COALESCE("public"."st_y"(("e"."location")::"public"."geometry"), ("e"."latitude")::double precision) AS "latitude",
    COALESCE("public"."st_x"(("e"."location")::"public"."geometry"), ("e"."longitude")::double precision) AS "longitude",
    "e"."country",
    "e"."region",
    "e"."timestamp",
    "e"."channel",
   ...
   FROM ("public"."events" "e"
     LEFT JOIN "public"."users" "u" ON (("e"."deleted_by" = "u"."id")))
  WHERE ("e"."deleted" = true);


ALTER TABLE "public"."archived_events" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."arms_deals" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp without time zone DEFAULT "now"(),
    CONSTRAINT "arms_deals_status_check" CHECK (("status" = ANY (ARRAY['confirmed'::"text", 'pending'::"text", 'cancelled'::"text"])))
);


ALTER TABLE "public"."arms_deals" OWNER TO "postgres";
...
COMMENT ON TABLE "public"."beta_signups" IS 'Stores beta program signup requests';



COMMENT ON COLUMN "public"."beta_signups"."email" IS 'User email address (unique constraint)';



COMMENT ON COLUMN "public"."beta_signups"."affiliation" IS 'Optional organization/company affiliation';
...
CREATE TABLE IF NOT EXISTS "public"."bias_analyses" (
    ...
    "emotional_language_score" numeric,
    "source_balance_score" numeric,
    "fact_selection_bias" numeric,
    "confidence" numeric,
    "explanation" "text",
    "analysis" "jsonb",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "bias_analyses_bias_category_check" CHECK (("bias_category" = ANY (ARRAY['far-left'::"text", 'left'::"text", 'lean-left'::"text", 'center'::"text", 'lean-right'::"text", 'right'::"text", 'far-right'::"text"]))),
    CONSTRAINT "bias_analyses_confidence_check" CHECK ((("confidence" >= (0)::numeric) AND ("confidence" <= (1)::numeric))),
    CONSTRAINT "bias_analyses_emotional_language_score_check" CHECK ((("emotional_language_score" >= (0)::numeric) AND ("emotional_language_score" <= (1)::numeric))),
    CONSTRAINT "bias_analyses_fact_selection_bias_check" CHECK ((("fact_selection_bias" >= ('-1'::integer)::numeric) AND ("fact_selection_bias" <= (1)::numeric))),
    CONSTRAINT "bias_analyses_overall_bias_check" CHECK ((("overall_bias" >= ('-5'::integer)::numeric) AND ("overall_bias" <= (5)::numeric))),
    CONSTRAINT "bias_analyses_political_bias_check" CHECK ((("political_bias" >= ('-1'::integer)::numeric) AND ("political_bias" <= (1)::numeric))),
    CONSTRAINT "bias_analyses_sensationalism_score_check" CHECK ((("sensationalism_score" >= (0)::numeric) AND ("sensationalism_score" <= (1)::numeric))),
    CONSTRAINT "bias_analyses_source_balance_score_check" CHECK ((("source_balance_score" >= (0)::numeric) AND ("source_balance_score" <= (1)::numeric)))
);


ALTER TABLE "public"."bias_analyses" OWNER TO "postgres";
...
ALTER TABLE "public"."conflict_events" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."conflict_events_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."conflict_events_id_seq" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."conflict_events_with_alias" AS
 SELECT "conflict_events"."id",
    "conflict_events"."title",
    "conflict_events"."description",
    "conflict_events"."url",
    "conflict_events"."event_date",
    "conflict_events"."source",
    "conflict_events"."source_type",
    "conflict_events"."country",
    "conflict_events"."region",
    "conflict_events"."latitude",
    "conflict_events"."longitude",
    "conflict_events"."location_confidence",
    "conflict_events"."event_type",
    "conflict_events"."severity_level",
    "conflict_events"."escalation_level",
    "conflict_events"."casualties_reported",
    "conflict_events"."casualties_killed",
    "conflict_events"."casualties_wounded",
    "conflict_events"."participants",
    "conflict_events"."tags",
    "conflict_events"."confidence_score",
    "conflict_events"."verification_status",
    "conflict_events"."content_hash",
    "conflict_events"."raw_content",
    "conflict_events"."external_id",
    "conflict_events"."language",
    "conflict_events"."escalation_factors",
    "conflict_events"."processed_at",
    "conflict_events"."fetched_at",
    "conflict_events"."created_at",
    "conflict_events"."updated_at",
    "conflict_events"."event_date" AS "timestamp"
   FROM "public"."conflict_events";


ALTER TABLE "public"."conflict_events_with_alias" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."conflict_sync_log" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."conflict_sync_log" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."event_deletion_log" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."event_deletion_log" OWNER TO "postgres";
...
ALTER TABLE "public"."event_versions" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."event_latest_versions" AS
 SELECT "e"."id",
    "e"."title",
    "e"."summary",
    "e"."location",
    ...
    ( SELECT "count"(*) AS "count"
          ...
          WHERE ("event_versions"."event_id" = "e"."id")) AS "total_versions",
    ( SELECT "event_versions"."created_at"
           FROM "public"."event_versions"
          WHERE ("event_versions"."event_id" = "e"."id")
          ORDER BY "event_versions"."version" DESC
         LIMIT 1) AS "last_version_date"
   FROM "public"."events" "e";


ALTER TABLE "public"."event_latest_versions" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."events_with_coords" AS
 SELECT "events"."id",
    "events"."title",
    "events"."summary",
    COALESCE("public"."st_y"(("events"."location")::"public"."geometry"), ("events"."latitude")::double precision) AS "latitude",
    COALESCE("public"."st_x"(("events"."location")::"public"."geometry"), ("events"."longitude")::double precision) AS "longitude",
    "events"."country",
    "events"."region",
    "events"."timestamp",
    "events"."channel",
    "events"."reliability",
    "events"."event_classifier",
    "events"."severity",
    "events"."source_url",
    "events"."created_at",
    "events"."updated_at"
...
ALTER TABLE "public"."events_with_coords" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."fact_check_results" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "fact_check_results_confidence_check" CHECK ((("confidence" >= (0)::numeric) AND ("confidence" <= (1)::numeric))),
    CONSTRAINT "fact_check_results_overall_verification_check" CHECK (("overall_verification" = ANY (ARRAY['verified'::"text", 'partially-verified'::"text", 'disputed'::"text", 'unverified'::"text"]))),
    CONSTRAINT "fact_check_results_verification_score_check" CHECK ((("verification_score" >= (0)::numeric) AND ("verification_score" <= (1)::numeric)))
);


ALTER TABLE "public"."fact_check_results" OWNER TO "postgres";
...
COMMENT ON TABLE "public"."feedback" IS 'Stores user feedback and suggestions';



COMMENT ON COLUMN "public"."feedback"."message" IS 'User feedback content (10-2000 characters)';
...
CREATE TABLE IF NOT EXISTS "public"."news" (
    ...
    "verification_status" "text",
    "has_analysis" boolean DEFAULT false,
    CONSTRAINT "news_escalation_score_check" CHECK ((("escalation_score" >= (0)::numeric) AND ("escalation_score" <= (10)::numeric)))
);
...
COMMENT ON COLUMN "public"."news"."escalation_score" IS 'AI-computed escalation score (0-10): 0=peaceful, 5=medium tension, 8+=critical threat level';



CREATE OR REPLACE VIEW "public"."high_escalation_news" AS
 SELECT "news"."id",
    "news"."title",
    "news"."url",
    "news"."source",
    ...
    "news"."updated_at"
   FROM "public"."news"
  WHERE ("news"."escalation_score" >= (6)::numeric)
  ORDER BY "news"."escalation_score" DESC, "news"."created_at" DESC;


ALTER TABLE "public"."high_escalation_news" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."invite_codes" (
    ...
    CONSTRAINT "code_format" CHECK ((("code")::"text" ~ '^[A-Z0-9]{6,8}$'::"text")),
...
CREATE TABLE IF NOT EXISTS "public"."invite_verifications" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "invite_code_id" "uuid" NOT NULL,
    "ip_address" "inet",
    "user_agent" "text",
...
ALTER TABLE "public"."invite_verifications" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."news_escalation_analytics" AS
 SELECT "news"."region",
    "news"."country",
    "count"(*) AS "article_count",
    "avg"("news"."escalation_score") AS "avg_escalation",
    "max"("news"."escalation_score") AS "max_escalation",
    "count"(
        CASE
            WHEN ("news"."escalation_score" >= (8)::numeric) THEN 1
            ELSE NULL::integer
        END) AS "critical_count",
    "count"(
        CASE
            WHEN ("news"."escalation_score" >= (6)::numeric) THEN 1
            ELSE NULL::integer
        END) AS "high_count",
    "count"(
        CASE
            WHEN ("news"."escalation_score" >= (4)::numeric) THEN 1
            ELSE NULL::integer
        END) AS "medium_count",
    "max"("news"."created_at") AS "latest_update"
   FROM "public"."news"
  WHERE ("news"."escalation_score" IS NOT NULL)
  GROUP BY "news"."region", "news"."country"
  ORDER BY ("avg"("news"."escalation_score")) DESC, ("count"(*)) DESC;


ALTER TABLE "public"."news_escalation_analytics" OWNER TO "postgres";
...
COMMENT ON TABLE "public"."news_sources" IS 'Tracks all news outlets reporting the same story for deduplication and credibility';



CREATE OR REPLACE VIEW "public"."news_with_alias" AS
 SELECT "news"."id",
    "news"."title",
    "news"."summary",
    "news"."url",
...
ALTER TABLE "public"."news_with_alias" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."news_with_sources" AS
SELECT
    NULL::integer AS "id",
    NULL::character varying(500) AS "title",
    NULL::"text" AS "summary",
    NULL::character varying(2000) AS "url",
...
CREATE TABLE IF NOT EXISTS "public"."user_preferences" (
    ...
    "notification_settings" "jsonb" DEFAULT '{"dailyDigest": false, "emailAlerts": false, "criticalOnly": false}'::"jsonb",
    "display_settings" "jsonb" DEFAULT '{"autoRefresh": true, "defaultView": "map", "refreshInterval": 60}'::"jsonb",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "user_preferences_severity_threshold_check" CHECK ((("severity_threshold" >= 1) AND ("severity_threshold" <= 10)))
);
...
CREATE OR REPLACE VIEW "public"."user_session_analytics" AS
...
ALTER TABLE "public"."user_session_analytics" OWNER TO "postgres";
...
ALTER TABLE ONLY "archive"."analytics_events"
    ADD CONSTRAINT "analytics_events_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."arms_deals"
    ADD CONSTRAINT "arms_deals_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."bias_analyses"
    ADD CONSTRAINT "bias_analyses_article_url_key" UNIQUE ("article_url");



ALTER TABLE ONLY "public"."bias_analyses"
    ADD CONSTRAINT "bias_analyses_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."conflict_events"
    ADD CONSTRAINT "conflict_events_content_hash_key" UNIQUE ("content_hash");
...
ALTER TABLE ONLY "public"."conflict_sync_log"
    ADD CONSTRAINT "conflict_sync_log_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."event_deletion_log"
    ADD CONSTRAINT "event_deletion_log_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."event_versions"
...
ALTER TABLE ONLY "public"."fact_check_results"
    ADD CONSTRAINT "fact_check_results_article_url_key" UNIQUE ("article_url");



ALTER TABLE ONLY "public"."fact_check_results"
    ADD CONSTRAINT "fact_check_results_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."invite_redemptions"
    ADD CONSTRAINT "invite_redemptions_user_id_key" UNIQUE ("user_id");



ALTER TABLE ONLY "public"."invite_verifications"
    ADD CONSTRAINT "invite_verifications_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."news"
    ADD CONSTRAINT "news_content_hash_key" UNIQUE ("content_hash");
...
ALTER TABLE ONLY "public"."news_sources"
    ADD CONSTRAINT "news_sources_news_id_outlet_key" UNIQUE ("news_id", "outlet");
...
CREATE INDEX "idx_analytics_events_category_action" ON "archive"."analytics_events" USING "btree" ("category", "action");



CREATE INDEX "idx_analytics_events_session_id" ON "archive"."analytics_events" USING "btree" ("session_id");



CREATE INDEX "idx_analytics_events_timestamp" ON "archive"."analytics_events" USING "btree" ("timestamp" DESC);



CREATE INDEX "idx_analytics_events_user_id" ON "archive"."analytics_events" USING "btree" ("user_id");



CREATE INDEX "idx_arms_deals_buyer_country" ON "public"."arms_deals" USING "btree" ("buyer_country");



CREATE INDEX "idx_arms_deals_countries" ON "public"."arms_deals" USING "btree" ("seller_country", "buyer_country");



CREATE INDEX "idx_arms_deals_date" ON "public"."arms_deals" USING "btree" ("date");



CREATE INDEX "idx_arms_deals_seller_country" ON "public"."arms_deals" USING "btree" ("seller_country");



CREATE INDEX "idx_arms_deals_status" ON "public"."arms_deals" USING "btree" ("status");



CREATE INDEX "idx_beta_signups_created_at" ON "public"."beta_signups" USING "btree" ("created_at");



CREATE INDEX "idx_beta_signups_email" ON "public"."beta_signups" USING "btree" ("email");



CREATE INDEX "idx_bias_analyses_category" ON "public"."bias_analyses" USING "btree" ("bias_category");



CREATE INDEX "idx_bias_analyses_created" ON "public"."bias_analyses" USING "btree" ("created_at");



CREATE INDEX "idx_bias_analyses_url" ON "public"."bias_analyses" USING "btree" ("article_url");



CREATE INDEX "idx_conflict_events_event_date" ON "public"."conflict_events" USING "btree" ("event_date" DESC);



CREATE INDEX "idx_conflict_sync_log_created_at" ON "public"."conflict_sync_log" USING "btree" ("created_at");



CREATE INDEX "idx_conflict_sync_log_operation" ON "public"."conflict_sync_log" USING "btree" ("operation");



CREATE INDEX "idx_conflicts_active_escalation" ON "public"."conflicts" USING "btree" ("status", "escalation_score" DESC) WHERE ("status" = 'active'::"text");



CREATE INDEX "idx_conflicts_active_status" ON "public"."conflicts" USING "btree" ("status", "auto_generated", "last_news_update") WHERE ("status" = 'active'::"text");



CREATE INDEX "idx_conflicts_auto_generated" ON "public"."conflicts" USING "btree" ("auto_generated");



CREATE INDEX "idx_conflicts_conflict_hash" ON "public"."conflicts" USING "btree" ("conflict_hash");



CREATE INDEX "idx_conflicts_country_region" ON "public"."conflicts" USING "btree" ("country", "region");



CREATE INDEX "idx_conflicts_escalation_calc" ON "public"."conflicts" USING "btree" ("status", "country", "escalation_last_calculated");



CREATE INDEX "idx_conflicts_escalation_score" ON "public"."conflicts" USING "btree" ("escalation_score");



CREATE INDEX "idx_conflicts_headline_hash" ON "public"."conflicts" USING "btree" ("headline_hash");



CREATE INDEX "idx_conflicts_last_news_update" ON "public"."conflicts" USING "btree" ("last_news_update");



CREATE INDEX "idx_conflicts_region" ON "public"."conflicts" USING "btree" ("region");



CREATE INDEX "idx_conflicts_source_article_id" ON "public"."conflicts" USING "btree" ("source_article_id");
...
CREATE INDEX "idx_conflicts_sync_lookup" ON "public"."conflicts" USING "btree" ("country", "region", "conflict_hash", "auto_generated");



CREATE INDEX "idx_conflicts_sync_source" ON "public"."conflicts" USING "btree" ("sync_source");



CREATE INDEX "idx_conflicts_updated_at" ON "public"."conflicts" USING "btree" ("updated_at");



CREATE INDEX "idx_event_deletion_log_deleted_at" ON "public"."event_deletion_log" USING "btree" ("deleted_at" DESC);



CREATE INDEX "idx_event_deletion_log_deleted_by" ON "public"."event_deletion_log" USING "btree" ("deleted_by");



CREATE INDEX "idx_event_deletion_log_event_id" ON "public"."event_deletion_log" USING "btree" ("event_id");



CREATE INDEX "idx_event_versions_created_at" ON "public"."event_versions" USING "btree" ("created_at" DESC);



CREATE INDEX "idx_event_versions_event_id" ON "public"."event_versions" USING "btree" ("event_id");



CREATE INDEX "idx_events_channel" ON "public"."events" USING "btree" ("channel");
...
CREATE INDEX "idx_events_classifier" ON "public"."events" USING "gin" ("event_classifier");



CREATE INDEX "idx_events_content_hash" ON "public"."events" USING "btree" ("content_hash");
...
CREATE INDEX "idx_events_country_region" ON "public"."events" USING "btree" ("country", "region");
...
CREATE INDEX "idx_events_dedup" ON "public"."events" USING "btree" ("content_hash", "country", "timestamp_date");



CREATE INDEX "idx_events_deleted" ON "public"."events" USING "btree" ("deleted");



CREATE INDEX "idx_events_deleted_at" ON "public"."events" USING "btree" ("deleted_at") WHERE ("deleted" = true);



CREATE INDEX "idx_events_deleted_by" ON "public"."events" USING "btree" ("deleted_by") WHERE ("deleted" = true);



CREATE INDEX "idx_events_escalation" ON "public"."conflict_events" USING "btree" ("escalation_level");



CREATE INDEX "idx_events_escalation_score" ON "public"."events" USING "btree" ("escalation_score");



CREATE INDEX "idx_events_escalation_timestamp" ON "public"."events" USING "btree" ("escalation_score", "timestamp" DESC);



CREATE INDEX "idx_events_event_date" ON "public"."conflict_events" USING "btree" ("event_date");
...
CREATE INDEX "idx_events_has_analysis" ON "public"."events" USING "btree" ("has_analysis");



CREATE INDEX "idx_events_latitude" ON "public"."events" USING "btree" ("latitude");
...
CREATE INDEX "idx_events_longitude" ON "public"."events" USING "btree" ("longitude");
...
CREATE INDEX "idx_events_search" ON "public"."events" USING "gin" ("to_tsvector"('"english"'::"regconfig", (("title" || ' '::"text") || "summary")));
...
CREATE INDEX "idx_events_severity_escalation" ON "public"."events" USING "btree" ("severity", "escalation_score" DESC);
...
CREATE INDEX "idx_events_source_type" ON "public"."events" USING "btree" ("source_type");
...
CREATE INDEX "idx_events_timestamp_desc" ON "public"."events" USING "btree" ("timestamp" DESC);



CREATE INDEX "idx_fact_check_created" ON "public"."fact_check_results" USING "btree" ("created_at");



CREATE INDEX "idx_fact_check_url" ON "public"."fact_check_results" USING "btree" ("article_url");



CREATE INDEX "idx_fact_check_verification" ON "public"."fact_check_results" USING "btree" ("overall_verification");
...
CREATE INDEX "idx_invite_codes_active" ON "public"."invite_codes" USING "btree" ("is_active", "expires_at");



CREATE INDEX "idx_invite_codes_assigned_user" ON "public"."invite_codes" USING "btree" ("assigned_user_id") WHERE ("assigned_user_id" IS NOT NULL);



CREATE INDEX "idx_invite_codes_code" ON "public"."invite_codes" USING "btree" ("code") WHERE ("is_active" = true);



CREATE INDEX "idx_invite_redemptions_code" ON "public"."invite_redemptions" USING "btree" ("invite_code_id");



CREATE INDEX "idx_invite_redemptions_user" ON "public"."invite_redemptions" USING "btree" ("user_id");



CREATE INDEX "idx_invite_verifications_code" ON "public"."invite_verifications" USING "btree" ("invite_code_id");



CREATE INDEX "idx_invite_verifications_verified_at" ON "public"."invite_verifications" USING "btree" ("verified_at");



CREATE INDEX "idx_news_content_hash" ON "public"."news" USING "btree" ("content_hash");



CREATE INDEX "idx_news_country" ON "public"."news" USING "btree" ("country");



CREATE INDEX "idx_news_country_region" ON "public"."news" USING "btree" ("country", "region") WHERE ("country" IS NOT NULL);



CREATE INDEX "idx_news_escalation_date" ON "public"."news" USING "btree" ("created_at" DESC, "escalation_score" DESC) WHERE ("escalation_score" IS NOT NULL);



CREATE INDEX "idx_news_escalation_region" ON "public"."news" USING "btree" ("region", "escalation_score" DESC) WHERE ("escalation_score" IS NOT NULL);



CREATE INDEX "idx_news_escalation_score" ON "public"."news" USING "btree" ("escalation_score" DESC);



CREATE INDEX "idx_news_has_analysis" ON "public"."news" USING "btree" ("has_analysis");
...
CREATE INDEX "idx_news_published_desc" ON "public"."news" USING "btree" ("published_at" DESC);
...
CREATE INDEX "idx_news_sources_added_at" ON "public"."news_sources" USING "btree" ("added_at");



CREATE INDEX "idx_news_sources_news_id" ON "public"."news_sources" USING "btree" ("news_id");



CREATE INDEX "idx_news_sources_outlet" ON "public"."news_sources" USING "btree" ("outlet");



CREATE INDEX "idx_news_unprocessed" ON "public"."news" USING "btree" ("processed_at") WHERE ("processed_at" IS NULL);



CREATE INDEX "idx_user_preferences_event_types" ON "public"."user_preferences" USING "gin" ("event_types");



CREATE INDEX "idx_user_preferences_interests" ON "public"."user_preferences" USING "gin" ("interests");



CREATE INDEX "idx_user_preferences_regions" ON "public"."user_preferences" USING "gin" ("regions");
...
CREATE OR REPLACE VIEW "public"."news_with_sources" AS
 SELECT "n"."id",
    ...
    COALESCE("jsonb_agg"("jsonb_build_object"('outlet', "ns"."outlet", 'url', "ns"."source_url", 'published_at', "ns"."published_at") ORDER BY "ns"."added_at") FILTER (WHERE ("ns"."id" IS NOT NULL)), '[]'::"jsonb") AS "sources"
   FROM ("public"."news" "n"
     LEFT JOIN "public"."news_sources" "ns" ON (("n"."id" = "ns"."news_id")))
  GROUP BY "n"."id", "n"."title", "n"."summary", "n"."url", "n"."source", "n"."published_at", "n"."created_at", "n"."updated_at", "n"."country", "n"."region", "n"."escalation_score", "n"."tags", "n"."content_hash", "n"."primary_source", "n"."source_count", "n"."is_multi_source", "n"."bias_analysis_id", "n"."fact_check_id", "n"."bias_score", "n"."verification_status";



CREATE OR REPLACE TRIGGER "after_event_insert_mark_conflicts" AFTER INSERT ON "public"."events" FOR EACH ROW WHEN (("new"."escalation_score" IS NOT NULL)) EXECUTE FUNCTION "public"."trigger_mark_conflict_for_update"();



CREATE OR REPLACE TRIGGER "event_deletion_audit_trigger" AFTER UPDATE ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."log_event_deletion"();



CREATE OR REPLACE TRIGGER "event_version_trigger" AFTER UPDATE ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."create_event_version"();



CREATE OR REPLACE TRIGGER "new_event_trigger" AFTER INSERT ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."notify_new_event"();



CREATE OR REPLACE TRIGGER "trg_sync_conflict_timestamp" BEFORE INSERT OR UPDATE ON "public"."conflict_events" FOR EACH ROW EXECUTE FUNCTION "public"."sync_conflict_timestamp"();



CREATE OR REPLACE TRIGGER "trg_sync_news_date" BEFORE INSERT OR UPDATE ON "public"."news" FOR EACH ROW EXECUTE FUNCTION "public"."sync_news_date"();



CREATE OR REPLACE TRIGGER "trg_update_timestamp_date" BEFORE INSERT OR UPDATE ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."update_timestamp_date"();



CREATE OR REPLACE TRIGGER "trigger_conflicts_updated_at" BEFORE UPDATE ON "public"."conflicts" FOR EACH ROW EXECUTE FUNCTION "public"."update_conflicts_updated_at"();
...
CREATE OR REPLACE TRIGGER "update_location_trigger" BEFORE INSERT OR UPDATE ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."update_location_from_coords"();
...
ALTER TABLE ONLY "public"."event_deletion_log"
    ADD CONSTRAINT "event_deletion_log_deleted_by_fkey" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."event_deletion_log"
    ADD CONSTRAINT "event_deletion_log_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id");



ALTER TABLE ONLY "public"."event_versions"
    ADD CONSTRAINT "event_versions_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "public"."events"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."events"
    ADD CONSTRAINT "events_bias_analysis_id_fkey" FOREIGN KEY ("bias_analysis_id") REFERENCES "public"."bias_analyses"("id");



ALTER TABLE ONLY "public"."events"
    ADD CONSTRAINT "events_deleted_by_fkey" FOREIGN KEY ("deleted_by") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."events"
    ADD CONSTRAINT "events_fact_check_id_fkey" FOREIGN KEY ("fact_check_id") REFERENCES "public"."fact_check_results"("id");



ALTER TABLE ONLY "public"."invite_codes"
    ADD CONSTRAINT "invite_codes_assigned_user_id_fkey" FOREIGN KEY ("assigned_user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."invite_redemptions"
    ADD CONSTRAINT "invite_redemptions_invite_code_id_fkey" FOREIGN KEY ("invite_code_id") REFERENCES "public"."invite_codes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."invite_redemptions"
    ADD CONSTRAINT "invite_redemptions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."invite_verifications"
    ADD CONSTRAINT "invite_verifications_invite_code_id_fkey" FOREIGN KEY ("invite_code_id") REFERENCES "public"."invite_codes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."news"
    ADD CONSTRAINT "news_bias_analysis_id_fkey" FOREIGN KEY ("bias_analysis_id") REFERENCES "public"."bias_analyses"("id");



ALTER TABLE ONLY "public"."news"
    ADD CONSTRAINT "news_fact_check_id_fkey" FOREIGN KEY ("fact_check_id") REFERENCES "public"."fact_check_results"("id");



ALTER TABLE ONLY "public"."news_sources"
    ADD CONSTRAINT "news_sources_news_id_fkey" FOREIGN KEY ("news_id") REFERENCES "public"."news"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_sessions"
    ADD CONSTRAINT "user_sessions_invite_code_id_fkey" FOREIGN KEY ("invite_code_id") REFERENCES "public"."invite_codes"("id") ON DELETE SET NULL;
...
CREATE POLICY "Service role can insert analytics events" ON "archive"."analytics_events" FOR INSERT TO "service_role" WITH CHECK (true);



CREATE POLICY "Users can view own analytics" ON "archive"."analytics_events" FOR SELECT TO "authenticated" USING (("user_id" = ("auth"."uid"())::"text"));
...
CREATE POLICY "Admins can update events for deletion" ON "public"."events" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));



CREATE POLICY "Admins can view all redemptions" ON "public"."invite_redemptions" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));
...
CREATE POLICY "Admins can view all verifications" ON "public"."invite_verifications" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));



CREATE POLICY "Allow ACLED import" ON "public"."events" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow admin read access" ON "public"."beta_signups" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "Allow admin read access" ON "public"."feedback" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "Allow public beta signup" ON "public"."beta_signups" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public feedback submission" ON "public"."feedback" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Enable delete for authenticated users" ON "public"."arms_deals" FOR DELETE USING (true);



CREATE POLICY "Enable delete for authenticated users" ON "public"."conflicts" FOR DELETE USING (true);



CREATE POLICY "Enable insert for all users" ON "public"."beta_signups" FOR INSERT WITH CHECK (true);



CREATE POLICY "Enable insert for authenticated users" ON "public"."arms_deals" FOR INSERT WITH CHECK (true);



CREATE POLICY "Enable insert for authenticated users" ON "public"."conflicts" FOR INSERT WITH CHECK (true);



CREATE POLICY "Enable read access for all users" ON "public"."arms_deals" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."conflicts" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."news_sources" FOR SELECT USING (true);



CREATE POLICY "Enable read for authenticated users" ON "public"."beta_signups" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));



CREATE POLICY "Enable update for authenticated users" ON "public"."arms_deals" FOR UPDATE USING (true);



CREATE POLICY "Enable update for authenticated users" ON "public"."conflicts" FOR UPDATE USING (true);



CREATE POLICY "Enable user signup" ON "public"."users" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Only admins can view deletion logs" ON "public"."event_deletion_log" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));



CREATE POLICY "Public read access for bias analyses" ON "public"."bias_analyses" FOR SELECT USING (true);



CREATE POLICY "Public read access for fact checks" ON "public"."fact_check_results" FOR SELECT USING (true);



CREATE POLICY "Service role can do everything" ON "public"."events" TO "service_role" USING (true);



CREATE POLICY "Service role write access for bias analyses" ON "public"."bias_analyses" USING (("auth"."role"() = 'service_role'::"text"));



CREATE POLICY "Service role write access for fact checks" ON "public"."fact_check_results" USING (("auth"."role"() = 'service_role'::"text"));
...
CREATE POLICY "Users can view own redemptions" ON "public"."invite_redemptions" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Users can view their assigned invite codes" ON "public"."invite_codes" FOR SELECT USING (("assigned_user_id" = "auth"."uid"()));



ALTER TABLE "public"."arms_deals" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."event_deletion_log" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."invite_verifications" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."archive_unused_table"("table_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."archive_unused_table"("table_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."archive_unused_table"("table_name" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."calculate_asymmetric_escalation"("p_conflict_id" "uuid", "p_new_events" "jsonb"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_asymmetric_escalation"("p_conflict_id" "uuid", "p_new_events" "jsonb"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_asymmetric_escalation"("p_conflict_id" "uuid", "p_new_events" "jsonb"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."calculate_conflict_escalation"("p_country" "text", "p_region" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_conflict_escalation"("p_country" "text", "p_region" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_conflict_escalation"("p_country" "text", "p_region" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_event_version"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_event_version"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_event_version"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."expire_inactive_conflicts"() TO "anon";
GRANT ALL ON FUNCTION "public"."expire_inactive_conflicts"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."expire_inactive_conflicts"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."generate_invite_code"("p_length" integer, "p_created_by" "uuid", "p_max_uses" integer, "p_expires_in_days" integer, "p_metadata" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."generate_invite_code"("p_length" integer, "p_created_by" "uuid", "p_max_uses" integer, "p_expires_in_days" integer, "p_metadata" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_invite_code"("p_length" integer, "p_created_by" "uuid", "p_max_uses" integer, "p_expires_in_days" integer, "p_metadata" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_event_history"("p_event_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_event_history"("p_event_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_event_history"("p_event_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_personalized_events"("p_user_id" "uuid", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_personalized_events"("p_user_id" "uuid", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_personalized_events"("p_user_id" "uuid", "p_limit" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."log_event_deletion"() TO "anon";
GRANT ALL ON FUNCTION "public"."log_event_deletion"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_event_deletion"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."merge_duplicate_news"("p_existing_id" "text", "p_new_article" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."merge_duplicate_news"("p_existing_id" "text", "p_new_article" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."merge_duplicate_news"("p_existing_id" "text", "p_new_article" "jsonb") TO "service_role";



GRANT ALL ON FUNCTION "public"."notify_new_event"() TO "anon";
GRANT ALL ON FUNCTION "public"."notify_new_event"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."notify_new_event"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."process_all_pending_escalations"() TO "anon";
GRANT ALL ON FUNCTION "public"."process_all_pending_escalations"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_all_pending_escalations"() TO "service_role";



GRANT ALL ON FUNCTION "public"."scheduled_escalation_update"() TO "anon";
GRANT ALL ON FUNCTION "public"."scheduled_escalation_update"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."scheduled_escalation_update"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_conflict_timestamp"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_conflict_timestamp"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_conflict_timestamp"() TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_news_date"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_news_date"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_news_date"() TO "service_role";



GRANT ALL ON FUNCTION "public"."track_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_invite_code_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text", "p_device_fingerprint" "text", "p_session_duration_hours" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."track_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_invite_code_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text", "p_device_fingerprint" "text", "p_session_duration_hours" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."track_user_session"("p_user_id" "uuid", "p_session_token" "text", "p_invite_code_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text", "p_device_fingerprint" "text", "p_session_duration_hours" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_mark_conflict_for_update"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_mark_conflict_for_update"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_mark_conflict_for_update"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_all_conflict_escalations"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_all_conflict_escalations"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_all_conflict_escalations"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_conflicts_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_conflicts_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_conflicts_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_country_conflict_escalations"("p_country" "text", "p_new_events" "jsonb"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."update_country_conflict_escalations"("p_country" "text", "p_new_events" "jsonb"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_country_conflict_escalations"("p_country" "text", "p_new_events" "jsonb"[]) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_single_conflict_escalation"("p_conflict_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."update_single_conflict_escalation"("p_conflict_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_single_conflict_escalation"("p_conflict_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_timestamp_date"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_timestamp_date"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_timestamp_date"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_and_redeem_invite_code"("p_code" character varying, "p_user_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."validate_and_redeem_invite_code"("p_code" character varying, "p_user_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_and_redeem_invite_code"("p_code" character varying, "p_user_id" "uuid", "p_ip_address" "inet", "p_user_agent" "text") TO "service_role";
...
GRANT ALL ON TABLE "archive"."analytics_events" TO "anon";
GRANT ALL ON TABLE "archive"."analytics_events" TO "authenticated";
GRANT ALL ON TABLE "archive"."analytics_events" TO "service_role";



GRANT ALL ON TABLE "archive"."analytics_daily_summary" TO "anon";
GRANT ALL ON TABLE "archive"."analytics_daily_summary" TO "authenticated";
GRANT ALL ON TABLE "archive"."analytics_daily_summary" TO "service_role";



GRANT ALL ON TABLE "archive"."analytics_popular_events" TO "anon";
GRANT ALL ON TABLE "archive"."analytics_popular_events" TO "authenticated";
GRANT ALL ON TABLE "archive"."analytics_popular_events" TO "service_role";
...
GRANT ALL ON TABLE "public"."active_conflicts" TO "anon";
GRANT ALL ON TABLE "public"."active_conflicts" TO "authenticated";
GRANT ALL ON TABLE "public"."active_conflicts" TO "service_role";
...
GRANT ALL ON TABLE "public"."archived_events" TO "anon";
GRANT ALL ON TABLE "public"."archived_events" TO "authenticated";
GRANT ALL ON TABLE "public"."archived_events" TO "service_role";



GRANT ALL ON TABLE "public"."arms_deals" TO "anon";
GRANT ALL ON TABLE "public"."arms_deals" TO "authenticated";
GRANT ALL ON TABLE "public"."arms_deals" TO "service_role";
...
GRANT ALL ON TABLE "public"."bias_analyses" TO "anon";
GRANT ALL ON TABLE "public"."bias_analyses" TO "authenticated";
GRANT ALL ON TABLE "public"."bias_analyses" TO "service_role";



GRANT ALL ON TABLE "public"."conflict_events" TO "anon";
GRANT ALL ON TABLE "public"."conflict_events" TO "authenticated";
GRANT ALL ON TABLE "public"."conflict_events" TO "service_role";



GRANT ALL ON SEQUENCE "public"."conflict_events_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."conflict_events_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."conflict_events_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."conflict_events_with_alias" TO "anon";
GRANT ALL ON TABLE "public"."conflict_events_with_alias" TO "authenticated";
GRANT ALL ON TABLE "public"."conflict_events_with_alias" TO "service_role";



GRANT ALL ON TABLE "public"."conflict_sync_log" TO "anon";
GRANT ALL ON TABLE "public"."conflict_sync_log" TO "authenticated";
GRANT ALL ON TABLE "public"."conflict_sync_log" TO "service_role";



GRANT ALL ON TABLE "public"."event_deletion_log" TO "anon";
GRANT ALL ON TABLE "public"."event_deletion_log" TO "authenticated";
GRANT ALL ON TABLE "public"."event_deletion_log" TO "service_role";



GRANT ALL ON TABLE "public"."event_versions" TO "anon";
GRANT ALL ON TABLE "public"."event_versions" TO "authenticated";
GRANT ALL ON TABLE "public"."event_versions" TO "service_role";



GRANT ALL ON TABLE "public"."event_latest_versions" TO "anon";
GRANT ALL ON TABLE "public"."event_latest_versions" TO "authenticated";
GRANT ALL ON TABLE "public"."event_latest_versions" TO "service_role";



GRANT ALL ON TABLE "public"."events_with_coords" TO "anon";
GRANT ALL ON TABLE "public"."events_with_coords" TO "authenticated";
GRANT ALL ON TABLE "public"."events_with_coords" TO "service_role";



GRANT ALL ON TABLE "public"."fact_check_results" TO "anon";
GRANT ALL ON TABLE "public"."fact_check_results" TO "authenticated";
GRANT ALL ON TABLE "public"."fact_check_results" TO "service_role";
...
GRANT ALL ON TABLE "public"."high_escalation_news" TO "anon";
GRANT ALL ON TABLE "public"."high_escalation_news" TO "authenticated";
GRANT ALL ON TABLE "public"."high_escalation_news" TO "service_role";
...
GRANT ALL ON TABLE "public"."invite_verifications" TO "anon";
GRANT ALL ON TABLE "public"."invite_verifications" TO "authenticated";
GRANT ALL ON TABLE "public"."invite_verifications" TO "service_role";



GRANT ALL ON TABLE "public"."news_escalation_analytics" TO "anon";
GRANT ALL ON TABLE "public"."news_escalation_analytics" TO "authenticated";
GRANT ALL ON TABLE "public"."news_escalation_analytics" TO "service_role";
...
GRANT ALL ON TABLE "public"."news_with_alias" TO "anon";
GRANT ALL ON TABLE "public"."news_with_alias" TO "authenticated";
GRANT ALL ON TABLE "public"."news_with_alias" TO "service_role";



GRANT ALL ON TABLE "public"."news_with_sources" TO "anon";
GRANT ALL ON TABLE "public"."news_with_sources" TO "authenticated";
GRANT ALL ON TABLE "public"."news_with_sources" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_session_analytics" TO "anon";
GRANT ALL ON TABLE "public"."user_session_analytics" TO "authenticated";
GRANT ALL ON TABLE "public"."user_session_analytics" TO "service_role";
