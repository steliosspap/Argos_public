...
import GlobeBackground from '@/agents/FrontendAgent/components/common/GlobeBackground';
...
export default function LandingPage() {
  ...
  useEffect(() => {
    setIsLoaded(true);
    // Ensure body can scroll on landing page
  ...
  return (
    <main id="main-content" className="relative overflow-auto">
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-black text-white mb-4 tracking-tight">
              ...
              >
                <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-white/90 mb-6 md:mb-8 font-light tracking-wide">
                  Global Conflict Intelligence
                </p>
                <p className="text-base sm:text-lg md:text-xl text-white/70 mb-8 md:mb-12 max-w-2xl mx-auto font-light leading-relaxed px-4 sm:px-0">
              ...
              >
                ...
                <Link
                  href="/signup"
                  className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-white bg-transparent border-2 border-white/30 rounded-lg hover:bg-white/10 transform hover:scale-105 active:scale-95 transition-all duration-200 backdrop-blur-sm touch-manipulation"
                >
                  <span>Sign Up</span>
              ...
              >
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-white/80 text-xs sm:text-sm font-medium">
                  Real-time Data
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 sm:px-4 py-1.5 sm:py-2 text-white/80 text-xs sm:text-sm font-medium">
                  AI-Powered Analysis
      ...
      <div id="platform-demo" className="relative bg-gradient-to-b from-slate-900 to-slate-800 py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            {/* Globe Container */}
            <div className="relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-3xl p-8 border-2 border-blue-500/20 shadow-2xl backdrop-blur-sm">
              {/* Stats Bar */}
              <div className="flex flex-wrap justify-center gap-6 mb-8 p-4 bg-black/20 rounded-2xl border border-white/5">
              ...
              <div className="mt-8 text-center">
                <p className="text-white/60 mb-4">
                  This is just a glimpse. Our platform processes <span className="text-blue-400 font-semibold">300+ events daily</span> with 
                  <span className="text-green-400 font-semibold"> real-time intelligence</span> from global sources.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <Link
                    href="/signup"
                    className="inline-flex items-center px-6 py-3 bg-transparent border border-white/20 text-white font-semibold rounded-lg hover:bg-white/5 transition-all duration-200"
                  >
                    Create Account
                  </Link>
                </div>
      ...
      {/* Footer */}
      <footer className="relative bg-slate-900 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center text-white/60 text-sm">
            <div className="mb-4 md:mb-0">
              <p>&copy; 2024 Argos. Built for global transparency and security.</p>
            </div>
            <div className="flex items-center space-x-6">
              <Link href="/intelligence-center" className="hover:text-white transition-colors">
                Intelligence Center
              </Link>
              <span className="text-white/30">•</span>
              <Link href="/feedback" className="text-white/50 hover:text-white/70 transition-colors text-sm">
                Send Feedback
              </Link>
            </div>
          </div>
